...
let updateTimeLeft: (time: number) => void; 
...
export default function ChallengeGame() {
  ...
  // FIX 5: Use `as const` on the timer style object
  const timerStyle = {
    fontWeight: 'bold',
    marginBottom: '5px',
    fontSize: timeLeft <= 10 && roundTimer !== null ? '20px' : '16px', 
  ...
  // FIX 5: Use `as const` on the infoBox style object
  const infoBoxStyle = {
    position: "absolute",
    top: 10,
    left: 10,
